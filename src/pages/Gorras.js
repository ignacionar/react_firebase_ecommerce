      ...
      <StyledProductsWrapper>
        <StyledFilters style={hideFilters ? {display: 'none'} : {display: 'grid'}}>
          ...
          <div style={{marginBottom: "10px"}}>
            ...
            <StyledULFilters>
              <StyledLIFilters><input type={'radio'} name='tipos' value='Gorra' onClick={(e) => setFilterType(e.target.value)}/> Gorra</StyledLIFilters>
              <StyledLIFilters><input type={'radio'} name='tipos' value='Piluso' onClick={(e) => setFilterType(e.target.value)}/> Piluso</StyledLIFilters>
              <StyledLIFilters><input type={'radio'} name='tipos' value='Sombrero' onClick={(e) => setFilterType(e.target.value)}/> Sombrero</StyledLIFilters>
            </StyledULFilters>
          </div>
