      ...
      <StyledProductsWrapper>
        <StyledFilters style={hideFilters ? {display: 'none'} : {display: 'grid'}}>
          ...
          <div style={{marginBottom: "10px"}}>
            ...
            <StyledULFilters>
              <StyledLIFilters><input type={'radio'} name='tipos' value='Zapatillas' onClick={(e) => setFilterType(e.target.value)}/> Zapatillas</StyledLIFilters>
              <StyledLIFilters><input type={'radio'} name='tipos' value='Tacos' onClick={(e) => setFilterType(e.target.value)}/> Tacos</StyledLIFilters>
              <StyledLIFilters><input type={'radio'} name='tipos' value='Zapatos' onClick={(e) => setFilterType(e.target.value)}/> Zapatos</StyledLIFilters>
            </StyledULFilters>
          </div>
        ...
        <StyledProducts>
          ...
          Object.entries(productItem).map(([indexNumber, product]) => {
            if (product.section === 'Calzados' && product.name.includes(search) && product.color.includes(filterColor) && product.type.includes(filterType)) {
              return (
